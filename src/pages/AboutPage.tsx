    ...
    <div className="relative min-h-screen bg-background transition-colors duration-500">
      ...
      {!isDark ? (
        ...
        <div className="flex flex-col">
            ...
            <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div>
                  ...
                  <h1 className="text-4xl md:text-6xl font-bold tracking-tight text-foreground">My Story</h1>
                </div>
          ...
          <section className="py-16 px-6 md:px-16 lg:px-24 bg-muted/30">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-2xl font-bold tracking-tight mb-8 text-foreground">What I Focus On</h2>
              <div className="columns-1 md:columns-2 lg:columns-3 gap-4 space-y-4">
                {interests.map((interest, i) => (
                  <motion.div 
                    ...
                    viewport={{ once: true }}
                    className="silk-card break-inside-avoid"
                  >
                    <interest.icon className="w-6 h-6 text-primary mb-3" />
                    <h3 className="text-lg font-bold tracking-tight mb-2">{interest.title}</h3>
          ...
          <section className="pt-24 pb-16 px-6 md:px-16 lg:px-24">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-foreground">My Story</h1>
              </div>
