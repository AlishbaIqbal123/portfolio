    ...
    const blurDivs = useMemo(() => {
        ...
        for (let i = 1; i <= config.divCount; i++) {
            ...
            if (config.exponential) {
                blurValue = math.pow(2, progress * 4) as any;
                blurValue *= 0.0625 * currentStrength;
            } else {
                blurValue = 0.0625 * (progress * config.divCount + 1) * currentStrength;
            }

            const p1 = (math.round as any)((increment * i - increment) * 10) / 10;
            const p2 = (math.round as any)(increment * i * 10) / 10;
            const p3 = (math.round as any)((increment * i + increment) * 10) / 10;
            const p4 = (math.round as any)((increment * i + increment * 2) * 10) / 10;
